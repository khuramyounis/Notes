...
import com.khuram.notes.framework.presentation.notedetail.state.NoteInteractionManager
...
const val NOTE_DETAIL_ERROR_RETRIEVING_SELECTED_NOTE = "Error retrieving selected note from bundle."
...
constructor(
    ...
    fun isToolbarExpanded() = collapsingToolbarState.toString() == CollapsingToolbarState.Expanded.toString()
